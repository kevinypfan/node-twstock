...
describe('TwseScraper', () => {
  ...
  describe('.fetchStocksCapitalReduction()', () => {
      ...
      expect(data).toEqual([
        {
          ...
          detailMeta: { symbol: '3432', date: '20240110' }
        },
        {
          ...
          rightsIssueReferencePrice: null,
          capitalReductionReason: '彌補虧損',
          detailMeta: { symbol: '2911', date: '20240227' }
        },
        {
          ...
          detailMeta: { symbol: '3308', date: '20240320' }
        }
      ]);
    });
    it('should fetch stocks capital reducation for the specified stock on the given date', async () => {
      ...
      const data = await scraper.fetchStocksCapitalReduction({ startDate: "2024-01-01", endDate: "2024-06-28", symbol: '2911' });
      expect(mockAxios.get).toHaveBeenCalledWith(
        'https://www.twse.com.tw/rwd/zh/reducation/TWTAUU?startDate=20240101&endDate=20240628&response=json',
      );
      expect(data).toBeDefined();
      ...
      expect(data).toEqual([
        {
          ...
          detailMeta: { symbol: "00690", date: "20240304" },
        },
        {
          resumptionDate: "2024-03-04",
          exchange: "TWSE",
          ...
          detailMeta: { symbol: "00913", date: "20240304" },
        },
      ]);
    });
  ...
  describe('.fetchStocksRightsAndDividendDetail()', () => {
    it('should fetch capital reducation detail for the given date and symbol', async () => {
      ...
      expect(data).toEqual({
        ...
        employeeBonusConvertedToStocks: 0,
        employeeSubscription: 0,
        publicSubscription: 0,
        rightPerShare: 0,
        shareholderSubscription: 0,
        stockName: "兆豐台灣晶圓製造",
        subscriptionAmountPerShare: 0,
        subscriptionPerThousandSharesByShareholdersRatio: 0,
        symbol: "00913",
      });
    });
